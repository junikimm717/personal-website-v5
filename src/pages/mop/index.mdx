...
In 2023, I attended the
[Mathematical Olympiad Program (MOP)](https://web.evanchen.cc/mop.html), a
three-week summer camp held at Carnegie Mellon University, as a member of the
blue group. It was easily one of the most transformative experiences of my life,
and I've remained connected to the community there ever since.
...
<Imagelist images={[[Puremoot, "puremootation"], [Reaper, "reaper"]]} size={500} dim="width" nonlazy>
...
import iltg from './1434.jpg';

<Imagelist images={[[iltg, "Mount 1434"]]} size={400} dim={'width'}>
  Mount 1434, a staple at MOP.
</Imagelist>

I've been maintaining a document which
contains the set of most/all memes people used during my three weeks at
