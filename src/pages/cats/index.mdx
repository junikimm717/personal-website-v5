...
<Imagelist images={[[Mimi1, "Mimi"], [Mimi2, "Mimi"]]} size={200} dim="height" nonlazy />

Mimi is a 3-year old Chinchilla Persian who enjoys sleeping in weird positions
and looking out the backyard for birds and chipmunks.

## Coco

<Imagelist images={[[Coco1, "Coco"], [Coco2, "Coco"]]} size={200} dim="height" nonlazy />

Coco is a 2-year old American Shorthair who enjoys play-hunting and spending way
too much time near his feeder.

[Past Life](https://www.youtube.com/watch?v=CT01DP6iq_E)
