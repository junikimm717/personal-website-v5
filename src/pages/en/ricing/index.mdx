...
[MacOS](/en/ricing/macos) and a variety of [Linux Distros](/en/ricing/linux).
...
| Window Manager  | bspwm/dwm                  | Yabai            |
| Document Viewer | Zathura                    | Skim             |
| Music           | Mpd with Ncmpcpp           | Mpd with Ncmpcpp |
| Virtualization  | QEMU/KVM with virt-manager | VMWare Fusion    |
...
- `mod-e` for running a custom
  [meeting joining program](https://github.com/junikimm717/mt).
...
- Depends on Distro:
  [Bootstrapping Scripts](https://git.junickim.me/junikimm717/server2023)
