...
I use a [custom neovim setup](https://git.junickim.me/junikimm717/nvim2023) with LSP, Telescope, and all the
other goodies baked in. Uses the catppuccin color scheme.
...
- [Go](https://golang.org); as one of my friends put it, Go is basically the
  Python of compiled languages. It's very easy to work with (cough cough Rust
  &gt;\_&lt;), the module system is dead-simple, and it's quite performant.
