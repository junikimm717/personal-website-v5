...
Below are some of the notable things that I've built. Almost all of my work is
publicly available either on [GitHub](https://github.com/junikimm717) or my
[personal git server](https://git.junickim.me).

I tend to work on projects which I think are somewhat novel and/or reasonably
useful to me and others; I use or have significantly used almost all my software.

## Search.MAATester.com

A search engine with 20,000 math olympiad problems from various sources.
Type-as-you-search functionality with Meilisearch. React/TypeScript frontend,
Go+Meilisearch backend, deployed on a VPS with Docker.
...
grading are built-in. Writen with React and Firebase
...
configuration system. A convenient version manager can also be installed.
